...
public class FinanceManager {
    ...
    public Map<String, BigDecimal> getSpendingByCategory() {
        // Optimization: Single-pass imperative loop avoids stream overhead
        // which improves performance according to benchmark.
        java.util.Map<String, BigDecimal> spending = new java.util.HashMap<>();
        for (Transaction t : transactions) {
